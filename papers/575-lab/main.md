...
\frac{\widetilde{∂}}{∂ \theta_i} \text{JumpReLU}_{\theta_i}(z) = -\frac{\theta_i}{\varepsilon}\, K\!\left(\frac{z - \theta_i}{\varepsilon}\right)
```
...
\frac{\widetilde{∂}}{∂ \theta_i} H(z - \theta_i) = -\frac{1}{\varepsilon}\, K\!\left(\frac{z - \theta_i}{\varepsilon}\right)
```
...
$\widetilde{∂} f_i / ∂ \pi_i = \mathbb{1}\{\pi_i > \theta_i\}$.
