...
most of it is not available in machine-readable formats; commonly, such data is
offered in CSV files, Excel spreadsheets, PDF tables, or even embedded in
figures. This work serves to fill both gaps:

 1. Encourage the use of a human- and machine-readable format to encode experimental
 data for combustion.
...
This talk will describe the components of PyTeCK, including the experimental
data parser, simulation framework, and solution post-processing. This will
include the theoretical basis for the models of shock tubes and rapid
compression machines.

Some example model evaluation results produced using PyTeCK will be also
presented and discussed, for combustion of the fuels *n*-heptane and isooctane.
