...
Its utility vs the full suite, why it exists -- simplicity for non-experts. etc.

Inputs, outputs, general workflow
---------------------------------

What the user needs to know to effectively apply it to their dataset. Maybe code examples in here showing how it can be used?

Parallelization, benchmarks
---------------------------

IDL vs Python, whole field is moving that way. Parallelization, Python versions vs OS etc too?

Best practices?
---------------

Not sure about this subsection, could maybe be folded into "general workflow."
...
Need to have a showcase example of its application. Anything from Les Houches that might be useful as a prototypical use case?
