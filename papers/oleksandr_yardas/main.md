...
\begin{table*}
    ...
    \begin{longtable*}{|c|c|}
        \toprule
        {\bf Nuclide} & {\bf Composition} [atom \%] \\ % Table header row
        \midrule
         $^{15}$O & 0.000758 \\
         $^{16}$O & 1.999242 \\
         $^{234}$U & 0.000385 \\
    ...
    \begin{longtable*}{0.333\linewidth}{|c|c|}
        \toprule
        {\bf Nuclide} & {\bf Composition} [atom \%] \\ % Table header row
        \midrule
         $^{1}$H & 1.999689\\
...
[](fig:actinides-error-casmo8-xs-days) and
...
[](fig:actinides-error-casmo8-xs-months) and
