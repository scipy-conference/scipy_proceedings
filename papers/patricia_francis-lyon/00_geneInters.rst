...
Three epistatic models are given by Gunther et al [G�nther09]_ as penetrance matrices. In each case  
...
.. [G�nther09] F. G�nther, N Wawro and K Bammann. *Neural networks for modeling gene-gene interactions in association studies*, 
