...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{assets/cdf_activation.pdf}\label{fig:cdf}
\includegraphics[width=0.4\textwidth]{assets/read_write.pdf}\label{fig:rw}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{assets/datamovement.pdf}\label{fig:dataplug_preprocess}
\includegraphics[width=0.55\textwidth]{assets/downloading.pdf}\label{fig:dataplug_downloading}
