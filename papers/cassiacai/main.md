...
3. Integration: Ocetrac is compatible with the Scientific Python ecosystem, including `dask` [@dask], `xarray` [@xarray] and  `scikit-learn` [@sklearn1]
...
Objects outlined (purple outlines) detected using varying $R$ values ($R$ ranging from 1° to 7°). The background shows sea surface temperature anomalies (°C) from February 2007 of an ensemble member of the CESM2-LENS dataset.
:::
