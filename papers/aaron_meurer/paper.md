...
numerical computing {cite}`Millman2011a; Harris2020a; Virtanen2020a; Okuta2017a; Rocklin2015a; Vanderwalt2014a; Hoyer2017a; Abbasi2018a`,
...
the [numpy.array_api](#numpy-array-api) reference implementation {cite}`Meurer2021a`, several
...
**Scalars:** _(lines 18-22)_ NumPy often supports non-array input arguments, such
...
@fig-2 [c] and @fig-2 [d] display results, showing average execution time
