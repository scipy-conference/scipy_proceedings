...
The percentage and counts of our vocabulary sharing a given number of closest words (SCW for short) between word2vec and our model for time bucket #17. :label:`sharedclosest`
