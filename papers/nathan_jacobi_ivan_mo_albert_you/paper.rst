...
In addition to the the change in the 100 dimensioned vector between each time bucket, the initial and next 10 dimensional positional vectors were included from each, which were generated using the same temporal embedding model.
...
Initial attemps at k-means with d = 100 dimensioned embeddings yeilded extremely large intertial values, therefore features were reassessed. 
