...
\begin{figure}[]
    \noindent
    \makebox[\columnwidth][c]{\includegraphics[width=\columnwidth]{figure1.png}}
    \caption{This is the caption. \label{egfig}}
\end{figure}

\begin{figure*}[]
    \noindent
    \makebox[\textwidth][c]{\includegraphics[width=\columnwidth]{figure1.png}}
...
\begin{figure}[bht]
    \noindent
    \makebox[\columnwidth][c]{\includegraphics[scale=0.20]{figure1.png}}
