...
documentation pages currently being built with Sphinx, RST and Numpydoc works can
...
database for object relation ship, and store other files on a Content Delivery
Network or blob
