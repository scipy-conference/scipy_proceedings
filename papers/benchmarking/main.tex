...
\texttt{sktime} and \texttt{tsbootstrap} provide fill-in extension templates\footnote{\href{https://github.com/sktime/sktime/tree/main/extension_templates}} for creating algorithms in a compatible interface, which can be shared in a third-party code base and indexed by \texttt{sktime}, or contributed directly to \texttt{sktime}.
...
From a software perspective, it is worth noting that \texttt{sktime} provides a unified interface across multiple packages in the time series ecosystem:
