...
More details can be found in the official tutorials (an overview of notebooks is provided in the \href{https://www.sktime.net/en/stable/user_guide.html#user-guide}{user guide}).
