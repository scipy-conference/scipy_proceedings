...
.. class:: abstract
   ...
   devices (HAD) research and development.  Digital filters of 200 taps for left and right ears are 
   ...
   here uses a database of HRIR's to describe a given subject. In the :code:`pyaudio_helper` application 
   ...
   Obtaining individual is a challenge in itself and the subject of much research. In a related 
   research project deep learning is being investigated as a means to fit a human to a large HRTF 
   data base of subjects based on anthropometrics of a particular subject. As a simple solution, 
...
the code known by its PRN number assigned to a particular satellite, is discernible
...
radial distance between the User and SV when multiplied by :math:`c`, the speed of light.
