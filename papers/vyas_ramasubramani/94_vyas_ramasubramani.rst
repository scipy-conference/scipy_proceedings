...
More involved demonstrations can be seen in the documentation [#]_, on the ``signac`` website [#]_, or in the paper in the Journal of Computational Materials Science :cite:`ADORF2018220`.
