...
Then, a Python script is developed to automate the download of images depicting the pre- or post-wildfire data using GEE's Python API (see Code \ref{lst:fire_processing}). To download three-channel RGB GeoTIFF imagery, the bands B4, B3, and B2 need to be specified (different band compositions can be selected in this step).  
