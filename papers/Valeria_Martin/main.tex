...
The VGG16 model is trained and validated on 95594 three-channel RGB images (divided as follows: 90\% for training and 10\% for validation) and is tested on 10621 images. Training took 1953 minutes for 10 epochs.
...
For testing purposes, this EF architecture is trained on 23833 pre- and post-wildfire image pairs (divided as follows: 90\% for training and 10\% for validation) and is tested on 2716 pre- and post-wildfire image pairs. Training took 933 minutes for 13 epochs. The detailed training and validation performance metrics for each epoch are provided in Table \ref{tab:1}. 
