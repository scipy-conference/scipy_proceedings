...
Project example for a group with good programming skills, college-level mathematics, engineering experience and interest in Neural Network may be Neural Network Design using tensorflow. Recommended material for self study: \cite {AG}
