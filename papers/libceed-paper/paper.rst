...
----------------------------------------------------------------------------------
LibCEED for Python is distributed through `PyPI <https://pypi.org/>`_ and can be easily installed via
...
These and other examples can be found in the suite of `Project Jupyter <https://jupyter.org/>`_ tutorials provided with libCEED in a dedicated `Binder <https://mybinder.org/v2/gh/CEED/libCEED/master?urlpath=lab/tree/examples/tutorials/tutorial-0-ceed.ipynb>`_ interactive environment.
