...
\andrei{A lot of time we emulate not a simulator but a process itself. Perhaps note that there is not always a simulator?}
...
\andrei{Maren, would you like to write a paragraph about your work on BQ with Alex G.? Or the one with Masha? Or both?}\maren{Yes, I can do that. Although the code of both papers unfortunately is not available online currently.} \andrei{That's quite alright, even better reason to explain what role Emukit played in them.}
