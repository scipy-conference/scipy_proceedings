...
Emukit's composability was also leveraged for implementation of BOSH, a novel sampling approach for Bayesian optimisation of functions with stochastic evaluations. Authors used hierarchical Gaussian process as a surrogate and designed novel BOSH acquisition function based on information-theoretic framework. Emukit was also used to assess BOSH performance against a variety of baselines.
