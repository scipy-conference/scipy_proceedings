...
\maren{we still have about 2 pages of space. Anything else we want to add? There is ample space for diagrams/figures/graphs if we wish to add some (for the more visual readers).}
...
\maren{I changed the section title because we do not seem to introduce the term `UQ' anywhere. Feel free to adjust it though.}
