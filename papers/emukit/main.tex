...
\maren{What do you think of this? E.g., we could use a BQ model, use it in a BO loop and integrate it in the end. This is a really cool feature of Emukit as it i) increases consistency of results and ii) lowers implementation overhead iii) may allows sharing of computational resources in the future between tasks. Need to check if it runs though.} \andrei{That's a good thing to point out, I can do that}\maren{Thank you!}
...
\maren{The shared core package may need to be a section on its own as its quite a unique feature of Emukit, perhaps including the diagram/graph that is also in the rtd. I added a placeholder subsection above. What do you think?} \andrei{I like that. I'll move this up to code samples section, and briefly reiterate here}
