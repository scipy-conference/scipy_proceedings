...
This work has made use of data from the European Space Agency (ESA) mission Gaia (`https://www.cosmos.esa.int/gaia <https://www.cosmos.esa.int/gaia>`_), processed by the Gaia Data Processing and Analysis Consortium DPAC (`https://www.cosmos.esa.int/web/gaia/dpac/consortium <https://www.cosmos.esa.int/web/gaia/dpac/consortium>`_). Funding for the DPAC has been provided by national institutions, in particular the institutions participating in the Gaia Multilateral Agreement.
