...
.. table:: Results of analysis. For each mailing list archive, number of participants :math:`n`,
           computed degree assortativity of the interaction graph :label:`mtable`

   +------------------+----------------+-----------+-------------+
   | list name        | Source         | :math:`n` |  d-assort.  |
   +==================+================+===========+=============+
   | numpy-discussion | SciPy          | 2973      | -0.21       |
   +------------------+----------------+-----------+-------------+
   | scipy-user       | SciPy          | 2735      | -0.11       |
   +------------------+----------------+-----------+-------------+
   | wikimedia-l      | WikiMedia      | 1729      | -0.16       |
   +------------------+----------------+-----------+-------------+
   | ipython-user     | SciPy          | 1085      | -0.27       |
   +------------------+----------------+-----------+-------------+
   | scipy-dev        | SciPy          | 1056      | -0.28       |
   +------------------+----------------+-----------+-------------+
   | ipython-dev      | SciPy          | 689       | -0.25       |
   +------------------+----------------+-----------+-------------+
   | hot              | OpenStreetMap  | 524       | -0.20       |
   +------------------+----------------+-----------+-------------+
   | astropy          | SciPy          | 404       | -0.17       |
   +------------------+----------------+-----------+-------------+
   | gendergap        | WikiMedia      | 301       | -0.17       |
   +------------------+----------------+-----------+-------------+
   | apug             | SciPy          | 121       | -0.21       |
   +------------------+----------------+-----------+-------------+
   | maps-l           | WikiMedia      | 118       | -0.19       |
   +------------------+----------------+-----------+-------------+
   | design           | WikiMedia      | 111       | -0.18       |
   +------------------+----------------+-----------+-------------+
   | potlatch-dev     | OpenStreetMap  | 75        | -0.06       |
   +------------------+----------------+-----------+-------------+
